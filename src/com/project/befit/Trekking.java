...
public class Trekking extends Activity {
	TextView tv;
	EditText et;
	int calo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trekking);
		tv = (TextView)findViewById(R.id.trekresult);
		et = (EditText)findViewById(R.id.trektime);
	}
public void trekressave(View view){
    ...
    if(ed_text.isEmpty() || ed_text.length() == 0 || ed_text.equals("") || ed_text == null)
    {
		...
		db.open();
		long id = db.insertExercise("trekking", formattedDate, result);
		db.close();
		db.open();
	...
	public void trekCalc(View view){
		String ed_text = et.getText().toString().trim();
