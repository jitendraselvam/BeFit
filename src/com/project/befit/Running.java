...
public class Running extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.runresult);
	    et = (EditText)findViewById(R.id.runtime);
	    
	    
	}
	public void runCalcsave(View view){
		...
		db.open();
		long id = db.insertExercise("Running", formattedDate, result);
		db.close();
		db.open();
