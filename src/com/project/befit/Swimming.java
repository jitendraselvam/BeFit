...
public class Swimming extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.swimresult);
		et = (EditText)findViewById(R.id.swimtime);
		
		
	}
public void swimressave(View view){
    ...
    if(ed_text.isEmpty() || ed_text.length() == 0 || ed_text.equals("") || ed_text == null)
    {
		...
		db.open();
		long id = db.insertExercise("swimming", formattedDate, result);
		db.close();
		db.open();
	...
	public void swimCalc(View view){
		String ed_text = et.getText().toString().trim();
