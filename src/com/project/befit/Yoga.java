...
public class Yoga extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.yogaresult);
		et = (EditText)findViewById(R.id.yogatime);
	}
public void yogaressave(View view){
    ...
    {Toast.makeText(getApplicationContext(), "no input", Toast.LENGTH_SHORT).show();}
		...
		db.open();
		long id = db.insertExercise("yoga", formattedDate, result);
		db.close();
		db.open();
	...
	public void yogaCalc(View view){
		String ed_text = et.getText().toString().trim();
