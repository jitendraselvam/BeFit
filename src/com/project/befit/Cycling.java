...
public class Cycling extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.cyclingresult);
		et = (EditText)findViewById(R.id.cyclingtime);
	}
public void cyclingressave(View view){
    ...
    if(ed_text.isEmpty() || ed_text.length() == 0 || ed_text.equals("") || ed_text == null)
    {
		...
		db.open();
		long id = db.insertExercise("cycling", formattedDate, result);
		db.close();
		db.open();
	...
	public void cyclingCalc(View view){
		String ed_text = et.getText().toString().trim();
