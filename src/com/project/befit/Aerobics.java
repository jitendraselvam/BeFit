...
public class Aerobics extends Activity {
	TextView tv;
	EditText et;
	int calo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.aerobicsresult);
		et = (EditText)findViewById(R.id.aerobicstime);
	}
public void aerobicsressave(View view){
    ...
    if(ed_text.isEmpty() || ed_text.length() == 0 || ed_text.equals("") || ed_text == null)
    {
		...
		db.open();
		long id = db.insertExercise("aerobics", formattedDate, result);
		db.close();
		db.open();
	...
	public void aerobicsCalc(View view){
		String ed_text = et.getText().toString().trim();
