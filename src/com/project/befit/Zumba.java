...
public class Zumba extends Activity {
	TextView tv;
	EditText et;
	int calo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.zumbaresult);
		et = (EditText)findViewById(R.id.zumbatime);
	}
public void zumbaressave(View view){
    ...
    {Toast.makeText(getApplicationContext(), "no input", Toast.LENGTH_SHORT).show();}
		...
		db.open();
		long id = db.insertExercise("zumba", formattedDate, result);
		db.close();
		db.open();
	...
	public void zumbaCalc(View view){
		String ed_text = et.getText().toString().trim();
