...
public class Pushup extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = (TextView)findViewById(R.id.pushupresult);
		et = (EditText)findViewById(R.id.pushuptime);
	}
public void pushupressave(View view){
    ...
    if(ed_text.isEmpty() || ed_text.length() == 0 || ed_text.equals("") || ed_text == null)
    {
		...
		db.open();
		long id = db.insertExercise("pushup", formattedDate, result);
		db.close();
		db.open();
	...
	public void pushupCalc(View view){
		String ed_text = et.getText().toString().trim();
